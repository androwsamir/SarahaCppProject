	...
	private: System::Windows::Forms::ListBox^ Chat;
		   ...
		   void Display_Contacts() {
			   for (pair<String^, long long>pr : Contacts) {
				   ...
				   Console::WriteLine(pr.first + " " + pr.second);
			   }
		   }
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Chat = (gcnew System::Windows::Forms::ListBox());
			...
			this->Chat->Location = System::Drawing::Point(7, 12);
			this->Chat->Name = L"Chat";
			this->Chat->Size = System::Drawing::Size(771, 516);
			...
			this->label2->Location = System::Drawing::Point(44, 89);
			...
			this->panel4->Controls->Add(this->Add_panel);
